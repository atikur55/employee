    ...
    <div class="header-top bg-3 py-1 border-bottom-1 ">
            <div class="container">
                <div class="header-top-wrap d-flex flex-wrap justify-content-between align-items-center">
                    <div class="right-side">
                        <ul>
                            ...
                            <li><a href="https://kiaras.in/track_order"><i class="lar la-box"></i> Track Your Order</a></li>
                        </ul>
                    </div>
                    <div class="left-side">
                        <div class="language_setting">
                            <div class="active_lang ">
                                    ...
                                    <div class="img">
                                        <img src="https://kiaras.in/assets/images/lang/icons8-india-flag-100.png" alt="image">
                                    </div>
                ...
                <div class="header-bottom-wrapper d-flex flex-wrap justify-content-between align-items-center">
                    ...
                    <form action="{{route('product.search')}}" method="GET" class="header-search-form mr-auto @if(!request()->routeIs('home')) w-100 @endif" >
                        <div class="header-form-group">
                            <input type="text" name="search_key" value="{{request()->search_key}}" placeholder="@lang('Search Product')...">
                            <button type="submit"><i class="las la-search"></i></button>
                        </div>
                        <div class="select-item">
                            <select class="select-bar" name="category_id">
                                <option selected value="0">@lang('ALL')</option>
                    ...
                    <ul class="shortcut-icons">
                        ...
                        <li>
                         <a href="https://api.whatsapp.com/send?phone=+918595738933">
                                <i class="fab fa-whatsapp fa-3x" style="color:		#32CD32"></i>                            </a>
                        </li>
                        <li>
